...
function InputCheck(create_form)  
{  
  if (create_form.pname.value == "")  
  {  
    alert("Please enter the project name!");  
    create_form.pname.focus();  
    return (false);  
  }  
  if (create_form.pdescription.value == "")  
  {  
    alert("Please enter the project description!");  
    create_form.pdescription.focus();  
    return (false);  
  }  
  if (create_form.pcategory.value == "")  
  {  
    alert("Please enter the project category!");  
    create_form.pcategory.focus();  
    return (false);  
  }  
  if (create_form.pminfunds.value == "")  
  {  
    alert("Please enter the minimum funds of the project!");  
    create_form.pminfunds.focus();  
    return (false);  
  }  
  if (create_form.pmaxfunds.value == "")  
  {  
    alert("Please enter the maximum funds of the project!");  
    create_form.pmaxfunds.focus();  
    return (false);  
  }  
  if (create_form.pendtime.value == "")  
  {  
    alert("Please enter the end date of the campaign!");  
    create_form.pendtime.focus();  
    return (false);  
  }  
  if (create_form.pplantime.value == "")  
  {  
    alert("Please enter the planned completion time for the project!");  
    create_form.pplantime.focus();  
    return (false);  
  }  
  if (create_form.pminfunds.value > create_form.pmaxfunds.value )  
  {  
    alert("Please reenter the minimum or maximum funds of the project!");  
    create_form.pminfunds.focus();  
    return (false);  
  } 
  var now = new Date().getTime();//当前时间戳
  var time_1 = new Date(document.getElementById('project_endtime').value).getTime();//1的时间戳
  if (time_1 < now)
  {
    alert("Please reenter the end date of the campaign!");  
    create_form.pendtime.focus();  
    return (false);  
  }  

  if (create_form.pplantime.value < create_form.pendtime.value) 
  {  
    alert("Please reenter the planned completion time and the end date of the campaign!");  
    create_form.pendtime.focus();  
    return (false);
  }
}  
    ...
    <div class="right">
        <div class="personal_des ">
            ...
            <div class="inforcon">
                ...
                <form class="tab-form" id="project_create_form" name="create_form" method="post" action="create.php" onSubmit="return InputCheck(this)" autocomplete="off">
                    <ul class="right">
                        <li>Project&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="project_name" placeholder="Enter Project Name Here" name="pname" />
                            <i class="error-tips"></i>
                        </li>

                        <li>Description&nbsp;<input type="text" id="project_description" name="pdescription" />
                            <i class="error-tips"></i>
                        </li>
                        
                        <li>Category&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="project_category" name="pcategory" />
                            <i class="error-tips"></i>
                        </li>
                        
                        <li>Min&nbsp;&nbsp;Funds&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" style ="width:300px;height:30px" type="text"id="project_minfunds" name="pminfunds" />
                        </li>

                        <li>Max&nbsp;&nbsp;Funds&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="number" style ="width:300px;height:30px" id="project_maxfunds" name="pmaxfunds" />
                        </li>

                        <li>End&nbsp;&nbsp;time&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" style ="width:300px;height:30px" id="project_endtime" name="pendtime" />
                        </li>
                        
                        </li>
                        <li>Planned time&nbsp;&nbsp;&nbsp;<input type="date" style ="width:300px;height:30px" id="project_plantime" name="pplantime" />
                        </li>
                        <li>
                        <input class="button btn-green btn-w100" id="jsAvatarBtn" type="submit" value="Submit" name="submit" />
                        </li>
                    </ul>
